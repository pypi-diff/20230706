# Comparing `tmp/cdk8s-2.7.93.tar.gz` & `tmp/cdk8s-2.7.94.tar.gz`
...
## Comparing `cdk8s-2.7.93.tar` & `cdk8s-2.7.94.tar`
...
### Comparing `cdk8s-2.7.93/LICENSE` & `cdk8s-2.7.94/LICENSE`

 * *Files identical despite different names*

### Comparing `cdk8s-2.7.93/PKG-INFO` & `cdk8s-2.7.94/PKG-INFO`
...
### Comparing `cdk8s-2.7.93/README.md` & `cdk8s-2.7.94/README.md`

 * *Files identical despite different names*

### Comparing `cdk8s-2.7.93/setup.py` & `cdk8s-2.7.94/setup.py`
...
### Comparing `cdk8s-2.7.93/src/cdk8s/__init__.py` & `cdk8s-2.7.94/src/cdk8s/__init__.py`

 * *Files identical despite different names*

### Comparing `cdk8s-2.7.93/src/cdk8s.egg-info/PKG-INFO` & `cdk8s-2.7.94/src/cdk8s.egg-info/PKG-INFO`
