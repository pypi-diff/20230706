# Comparing `tmp/django_sql_explorer_squad-0.9.7-py3-none-any.whl.zip` & `tmp/django_sql_explorer_squad-0.9.8-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,51 +1,55 @@
-Zip file size: 56363 bytes, number of entries: 49
--rw-r--r--  2.0 unx      581 b- defN 23-Mar-15 11:27 explorer/__init__.py
...
--rw-r--r--  2.0 unx     9680 b- defN 23-Jul-05 13:06 explorer/models.py
...
--rw-r--r--  2.0 unx      244 b- defN 23-Jul-05 13:08 django_sql_explorer_squad-0.9.7.dist-info/AUTHORS
--rw-r--r--  2.0 unx     1090 b- defN 23-Jul-05 13:08 django_sql_explorer_squad-0.9.7.dist-info/LICENSE
--rw-r--r--  2.0 unx    16232 b- defN 23-Jul-05 13:08 django_sql_explorer_squad-0.9.7.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 23-Jul-05 13:08 django_sql_explorer_squad-0.9.7.dist-info/WHEEL
--rw-r--r--  2.0 unx        9 b- defN 23-Jul-05 13:08 django_sql_explorer_squad-0.9.7.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     4384 b- defN 23-Jul-05 13:08 django_sql_explorer_squad-0.9.7.dist-info/RECORD
-49 files, 161335 bytes uncompressed, 49287 bytes compressed:  69.5%
...
-Filename: django_sql_explorer_squad-0.9.7.dist-info/AUTHORS
...
-Filename: django_sql_explorer_squad-0.9.7.dist-info/LICENSE
+Filename: django_sql_explorer_squad-0.9.8.dist-info/LICENSE
 Comment: 
 
-Filename: django_sql_explorer_squad-0.9.7.dist-info/METADATA
+Filename: django_sql_explorer_squad-0.9.8.dist-info/METADATA
 Comment: 
 
-Filename: django_sql_explorer_squad-0.9.7.dist-info/WHEEL
+Filename: django_sql_explorer_squad-0.9.8.dist-info/WHEEL
 Comment: 
 
-Filename: django_sql_explorer_squad-0.9.7.dist-info/top_level.txt
+Filename: django_sql_explorer_squad-0.9.8.dist-info/top_level.txt
 Comment: 
 
-Filename: django_sql_explorer_squad-0.9.7.dist-info/RECORD
 ...
 * *Format-specific differences are supported for Python .pyc files but no file-specific differences were detected; falling back to a binary diff. file(1) reports: Byte-compiled Python module for CPython 3.9, timestamp-based, .py timestamp: Wed Mar 15 11:27:21 2023 UTC, .py size: 581 bytes*
...
## Comparing `django_sql_explorer_squad-0.9.7.dist-info/LICENSE` & `django_sql_explorer_squad-0.9.8.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `django_sql_explorer_squad-0.9.7.dist-info/METADATA` & `django_sql_explorer_squad-0.9.8.dist-info/METADATA`
...
-
-## Command to generate pip package
-1. Create an account on Pypi.org
-2. Update version in setup.py
-3. Run ``python setup.py bdist_wheel``
-4. Run ``pip install twine``
-5. Run ``twine upload dist/*``
-6. Enter your credentials for authentication
```

## Comparing `django_sql_explorer_squad-0.9.7.dist-info/RECORD` & `django_sql_explorer_squad-0.9.8.dist-info/RECORD`
...
-explorer/models.py,sha256=v9-BJJgVB3aOt8g4S5ehpNJ_m4eov_6B6X7rRqp_Glw,9680
...
-django_sql_explorer_squad-0.9.7.dist-info/AUTHORS,sha256=-yOIuXJ7TC0-m-gAy0Gjc3ez1eK0a-o7u9B7WCgqB6Y,244
-django_sql_explorer_squad-0.9.7.dist-info/LICENSE,sha256=hyOjdzZR7ljYNZbISAWLjgNRz6_b3-5EQfz2hOsvg3g,1090
-django_sql_explorer_squad-0.9.7.dist-info/METADATA,sha256=nc10SK5y8veyQxIGns5MfgZSsq__xwWOGOm8NpRiwiw,16232
-django_sql_explorer_squad-0.9.7.dist-info/WHEEL,sha256=2wepM1nk4DS4eFpYrW1TTqPcoGNfHhhO_i5m4cOimbo,92
-django_sql_explorer_squad-0.9.7.dist-info/top_level.txt,sha256=HS5-rAbNJAJEVP0OygxhpNOCiXv092OahmzE5wX-k4s,9
-django_sql_explorer_squad-0.9.7.dist-info/RECORD,,
