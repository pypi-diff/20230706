# Comparing `tmp/autogluon-0.8.2b20230704.tar.gz` & `tmp/autogluon-0.8.2b20230705.tar.gz`
...
## Comparing `autogluon-0.8.2b20230704.tar` & `autogluon-0.8.2b20230705.tar`
...
### Comparing `autogluon-0.8.2b20230704/PKG-INFO` & `autogluon-0.8.2b20230705/PKG-INFO`
...
### Comparing `autogluon-0.8.2b20230704/setup.py` & `autogluon-0.8.2b20230705/setup.py`

 * *Files identical despite different names*

### Comparing `autogluon-0.8.2b20230704/src/autogluon.egg-info/PKG-INFO` & `autogluon-0.8.2b20230705/src/autogluon.egg-info/PKG-INFO`
