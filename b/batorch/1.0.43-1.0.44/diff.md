# Comparing `tmp/batorch-1.0.43.tar.gz` & `tmp/batorch-1.0.44.tar.gz`
...
### Comparing `batorch-1.0.43/batorch/nn/_reduction.py` & `batorch-1.0.44/batorch/nn/_reduction.py`
