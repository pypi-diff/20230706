# Comparing `tmp/yaxil-0.9.7-py2.py3-none-any.whl.zip` & `tmp/yaxil-0.9.8-py2.py3-none-any.whl.zip`
...
## Comparing `yaxil-0.9.7.data/scripts/ArcGet.py` & `yaxil-0.9.8.data/scripts/ArcGet.py`

 * *Files identical despite different names*

## Comparing `yaxil-0.9.7.data/scripts/xnat_auth` & `yaxil-0.9.8.data/scripts/xnat_auth`

 * *Files identical despite different names*

## Comparing `yaxil-0.9.7.dist-info/LICENSE` & `yaxil-0.9.8.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `yaxil-0.9.7.dist-info/RECORD` & `yaxil-0.9.8.dist-info/RECORD`
