# Comparing `tmp/mwj-apitest-1.0.1.tar.gz` & `tmp/mwj-apitest-1.0.3.tar.gz`
...
+gzip compressed data, was "mwj-apitest-1.0.3.tar", last modified: Thu Jul  6 10:17:19 2023, max compression
```

## Comparing `mwj-apitest-1.0.1.tar` & `mwj-apitest-1.0.3.tar`
...
+drwxrwxrwx   0        0        0        0 2023-07-06 10:17:19.464662 mwj-apitest-1.0.3/
+-rw-rw-rw-   0        0        0     1091 2023-05-31 08:57:31.000000 mwj-apitest-1.0.3/LICENSE
+-rw-rw-rw-   0        0        0       34 2023-05-31 08:08:20.000000 mwj-apitest-1.0.3/MANIFEST.in
+-rw-rw-rw-   0        0        0      630 2023-07-06 10:17:19.464662 mwj-apitest-1.0.3/PKG-INFO
+-rw-rw-rw-   0        0        0      151 2023-07-06 09:33:36.000000 mwj-apitest-1.0.3/README.md
+drwxrwxrwx   0        0        0        0 2023-07-06 10:17:19.448305 mwj-apitest-1.0.3/mwjApiTest/
+-rw-rw-rw-   0        0        0      215 2023-05-31 09:41:04.000000 mwj-apitest-1.0.3/mwjApiTest/__init__.py
+drwxrwxrwx   0        0        0        0 2023-07-06 10:17:19.449305 mwj-apitest-1.0.3/mwjApiTest/core/
+-rw-rw-rw-   0        0        0      190 2023-05-31 08:48:04.000000 mwj-apitest-1.0.3/mwjApiTest/core/__init__.py
+-rw-rw-rw-   0        0        0     1140 2023-05-31 11:08:47.000000 mwj-apitest-1.0.3/mwjApiTest/manage.py
+drwxrwxrwx   0        0        0        0 2023-07-06 10:17:19.451300 mwj-apitest-1.0.3/mwjApiTest/utils/
+-rw-rw-rw-   0        0        0      190 2023-05-31 08:48:04.000000 mwj-apitest-1.0.3/mwjApiTest/utils/__init__.py
+drwxrwxrwx   0        0        0        0 2023-07-06 10:17:19.463267 mwj-apitest-1.0.3/mwj_apitest.egg-info/
+-rw-rw-rw-   0        0        0      630 2023-07-06 10:17:19.000000 mwj-apitest-1.0.3/mwj_apitest.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      317 2023-07-06 10:17:19.000000 mwj-apitest-1.0.3/mwj_apitest.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-07-06 10:17:19.000000 mwj-apitest-1.0.3/mwj_apitest.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       54 2023-07-06 10:17:19.000000 mwj-apitest-1.0.3/mwj_apitest.egg-info/entry_points.txt
+-rw-rw-rw-   0        0        0       11 2023-07-06 10:17:19.000000 mwj-apitest-1.0.3/mwj_apitest.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2023-07-06 10:17:19.464662 mwj-apitest-1.0.3/setup.cfg
+-rw-rw-rw-   0        0        0     1516 2023-07-06 10:17:01.000000 mwj-apitest-1.0.3/setup.py
```

### Comparing `mwj-apitest-1.0.1/LICENSE` & `mwj-apitest-1.0.3/LICENSE`

 * *Files identical despite different names*

### Comparing `mwj-apitest-1.0.1/mwjApiTest/manage.py` & `mwj-apitest-1.0.3/mwjApiTest/manage.py`

 * *Files identical despite different names*

### Comparing `mwj-apitest-1.0.1/setup.py` & `mwj-apitest-1.0.3/setup.py`
...
+    version="1.0.3",  # 包版本号，便于维护版本,保证每次发布都是版本都是唯一的
