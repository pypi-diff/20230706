# Comparing `tmp/msadocmodels-0.0.83.tar.gz` & `tmp/msaDocModels-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "msaDocModels-0.0.83.tar", last modified: Thu Jul  6 12:18:23 2023, max compression
+gzip compressed data, was "msaDocModels-0.0.9.tar", last modified: Fri Nov 25 11:39:48 2022, max compression
```

## Comparing `msadocmodels-0.0.83.tar` & `msaDocModels-0.0.9.tar`

### file list

```diff
@@ -1,24 +1,24 @@
-drwxrwxr-x   0 demigorrgon  (1000) demigorrgon  (1000)        0 2023-07-06 12:18:23.330465 msaDocModels-0.0.83/
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     1099 2022-12-06 15:15:17.000000 msaDocModels-0.0.83/LICENCE
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     3699 2023-07-06 12:18:23.330465 msaDocModels-0.0.83/PKG-INFO
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     2198 2022-12-06 15:15:17.000000 msaDocModels-0.0.83/README.md
-drwxrwxr-x   0 demigorrgon  (1000) demigorrgon  (1000)        0 2023-07-06 12:18:23.330465 msaDocModels-0.0.83/msaDocModels/
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)      479 2023-07-06 12:18:14.000000 msaDocModels-0.0.83/msaDocModels/__init__.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)      562 2022-12-06 15:15:17.000000 msaDocModels-0.0.83/msaDocModels/health.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     3763 2023-07-06 07:23:59.000000 msaDocModels-0.0.83/msaDocModels/msg.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)      409 2023-07-06 07:23:59.000000 msaDocModels-0.0.83/msaDocModels/openapi.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     2413 2022-12-06 15:15:17.000000 msaDocModels-0.0.83/msaDocModels/scheduler.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)   154216 2023-07-06 07:27:13.000000 msaDocModels-0.0.83/msaDocModels/sdu.py
-drwxrwxr-x   0 demigorrgon  (1000) demigorrgon  (1000)        0 2023-07-06 12:18:23.330465 msaDocModels-0.0.83/msaDocModels/utils/
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)        0 2022-12-06 15:15:17.000000 msaDocModels-0.0.83/msaDocModels/utils/__init__.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     1826 2022-12-06 15:15:17.000000 msaDocModels-0.0.83/msaDocModels/utils/htmlutils.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)    22179 2023-07-06 07:23:59.000000 msaDocModels-0.0.83/msaDocModels/wdc.py
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     2103 2023-07-06 07:23:59.000000 msaDocModels-0.0.83/msaDocModels/wfl.py
-drwxrwxr-x   0 demigorrgon  (1000) demigorrgon  (1000)        0 2023-07-06 12:18:23.330465 msaDocModels-0.0.83/msaDocModels.egg-info/
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     3699 2023-07-06 12:18:23.000000 msaDocModels-0.0.83/msaDocModels.egg-info/PKG-INFO
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)      442 2023-07-06 12:18:23.000000 msaDocModels-0.0.83/msaDocModels.egg-info/SOURCES.txt
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)        1 2023-07-06 12:18:23.000000 msaDocModels-0.0.83/msaDocModels.egg-info/dependency_links.txt
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)       13 2023-07-06 12:18:23.000000 msaDocModels-0.0.83/msaDocModels.egg-info/top_level.txt
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)        1 2023-07-06 11:31:42.000000 msaDocModels-0.0.83/msaDocModels.egg-info/zip-safe
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)       38 2023-07-06 12:18:23.330465 msaDocModels-0.0.83/setup.cfg
--rw-rw-r--   0 demigorrgon  (1000) demigorrgon  (1000)     2164 2023-07-06 07:23:59.000000 msaDocModels-0.0.83/setup.py
...
### Comparing `msaDocModels-0.0.83/LICENCE` & `msaDocModels-0.0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.83/PKG-INFO` & `msaDocModels-0.0.9/PKG-INFO`
...
-Download-URL: http://pypi.python.org/pypi/msaDocModels
 ...
 Project-URL: Source, https://github.com/swelcker/msaDocModels
 Project-URL: Tracker, https://github.com/swelcker/msaDocModels/issues
-Platform: UNKNOWN
...
```diff
@@ -1,45 +1,44 @@
-Metadata-Version: 2.1 Name: msaDocModels Version: 0.0.83 Summary: msaDocModels
...
-msaDocModels Author: Stefan Welcker Author-email: stefan@u2d.ai License: MIT
-Download-URL: http://pypi.python.org/pypi/msaDocModels Project-URL:
...
-swelcker/msaDocModels/issues Platform: UNKNOWN Classifier: Development Status
-:: 4 - Beta Classifier: Framework :: FastAPI Classifier: Intended Audience ::
...
-Python :: 3.10 Classifier: Topic :: Database Classifier: Topic :: Database ::
-Front-Ends Classifier: Topic :: Documentation Classifier: Topic :: Internet ::
-WWW/HTTP :: WSGI :: Server Classifier: Topic :: Software Development ::
-Libraries Classifier: Topic :: Software Development :: Libraries :: Python
-Modules Description-Content-Type: text/markdown License-File: LICENCE
...
+Topic :: Database Classifier: Topic :: Database :: Front-Ends Classifier: Topic
+:: Documentation Classifier: Topic :: Internet :: WWW/HTTP :: WSGI :: Server
+Classifier: Topic :: Software Development :: Libraries Classifier: Topic ::
+Software Development :: Libraries :: Python Modules Description-Content-Type:
+text/markdown License-File: LICENCE
                               [msaDocModels Logo]
 ------
 msaDocModels - MSA Document Pydantic Models and Schemas, used to store Parser,
...
### Comparing `msaDocModels-0.0.83/README.md` & `msaDocModels-0.0.9/README.md`
...
### Comparing `msaDocModels-0.0.83/msaDocModels/health.py` & `msaDocModels-0.0.9/msaDocModels/health.py`

 * *Files identical despite different names*

### Comparing `msaDocModels-0.0.83/msaDocModels/msg.py` & `msaDocModels-0.0.9/msaDocModels/msg.py`
...
### Comparing `msaDocModels-0.0.83/msaDocModels/scheduler.py` & `msaDocModels-0.0.9/msaDocModels/scheduler.py`
...
### Comparing `msaDocModels-0.0.83/msaDocModels/utils/htmlutils.py` & `msaDocModels-0.0.9/msaDocModels/utils/htmlutils.py`
...
### Comparing `msaDocModels-0.0.83/msaDocModels/wdc.py` & `msaDocModels-0.0.9/msaDocModels/wdc.py`
...
### Comparing `msaDocModels-0.0.83/msaDocModels/wfl.py` & `msaDocModels-0.0.9/msaDocModels/wfl.py`
...
### Comparing `msaDocModels-0.0.83/msaDocModels.egg-info/PKG-INFO` & `msaDocModels-0.0.9/msaDocModels.egg-info/PKG-INFO`
