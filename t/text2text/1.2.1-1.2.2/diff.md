# Comparing `tmp/text2text-1.2.1.tar.gz` & `tmp/text2text-1.2.2.tar.gz`
...
### Comparing `text2text-1.2.1/text2text.egg-info/SOURCES.txt` & `text2text-1.2.2/text2text.egg-info/SOURCES.txt`
